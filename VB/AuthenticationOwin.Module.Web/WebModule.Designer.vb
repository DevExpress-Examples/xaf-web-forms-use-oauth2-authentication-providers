Namespace AuthenticationOwin.Module.Web
    Partial Public Class AuthenticationOwinAspNetModule
        ''' <summary> 
        ...
        Private Sub InitializeComponent()
            ' 
            ' AuthenticationOwinAspNetModule
            ' 
            Me.RequiredModuleTypes.Add(GetType(AuthenticationOwin.Module.AuthenticationOwinModule))
