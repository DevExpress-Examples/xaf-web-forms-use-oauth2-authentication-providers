...
Namespace AuthenticationOwin.Web
    ...
    Partial Public Class AuthenticationOwinAspNetApplication
        ...
        Private AuthenticationBase As DevExpress.ExpressApp.Security.AuthenticationBase
        ...
        End Function
        Private Sub AuthenticationOwinAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles Me.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            Me.AuthenticationBase = New AuthenticationStandartWithOAuth()
            ...
            ' 
            Me.securityStrategyComplex1.Authentication = Me.AuthenticationBase
            ...
            ' 
            CType(AuthenticationBase, AuthenticationStandartWithOAuth).LogonParametersType = GetType(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters)
